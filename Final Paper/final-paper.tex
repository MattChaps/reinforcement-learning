...
% Although our agents did not perform as well as expected, we conducted in-depth analysis in the evaluation to explain their behaviour. We also reflected on the project aims, giving reasons for why the intermediate and advanced objectives were not met, and describe what future work can be done.      
...
\end{figure}
\footnotetext{made using the online tool `NN-SVG' (github.com/alexlenail/NN-SVG)}  
...
\begin{figure}[ht]
    \centering
    \subfloat[Input state.]{\includegraphics[width=0.49\textwidth]{experiment-1.png}}
    \hfill
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{best-agent.png}
